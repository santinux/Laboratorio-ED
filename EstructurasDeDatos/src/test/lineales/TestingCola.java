 ...
 * ¡OJO! Hay Strings esperados cuya orden de encolado no existe. Ej.: "Verifica copia espera [5 6 7 8 9 <10 11> 23 24 <27>]"
 */
	...
	public static void testCola() {
		...
		while (num < 12) {
			...
			System.out.println("\t--> " + q1.toString());
                        //System.out.println("Está llena? " + q1.esLlena());
                        //System.out.println(q1.dondeEstaFrenteYFin());
		}
		...
		Cola q2 = q1.clonar();
		System.out.println("Copia espera " + q1.toString() + ": \t\t\t\t--> " + q2.toString());
