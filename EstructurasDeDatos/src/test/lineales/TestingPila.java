...
/**
 * Test para TDA Pila.
 * @author Catedra EDAT - FAI - UNCOMA & santino.fuentes
 * Ultima modificación: 22/04/2021.
 * @version 2.0 01/04/24.
 */
public class TestingPila {
        ...
        /**
         * Ejercicio 3:
         * Dada una pila llena con dígitos (0..9), verifica si la secuencia
         * forma un número capicúa o no.
         * Nota : Utilizar una pila auxiliar para facilitar la operación.
         * @return boolean
         */
        public static boolean esCapicua(Pila unaSecuencia)
        {
